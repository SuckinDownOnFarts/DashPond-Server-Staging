    ...
    const chartData = [
        {
            ...
            "value": data.DP03_0076E[radius],
        },
        {
            "id": '$10,000 to $14,999',
            'label': '$10,000 to $14,999',
            "value": data.DP03_0077E[radius],
        },
        {
            "id": '$15,000 to $24,999',
            'label': '$15,000 to $24,999',
            "value": data.DP03_0078E[radius],
        },
        {
            "id": '$25,000 to $34,999',
            'label': '$25,000 to $34,999',
            "value": data.DP03_0079E[radius],
        },
        {
            "id": '$35,000 to $49,999',
            'label': '$35,000 to $49,999',
            "value": data.DP03_0080E[radius],
        },
        {
            "id": '$50,000 to $74,999',
            'label': '$50,000 to $74,999',
            "value": data.DP03_0081E[radius],
        },
        {
            "id": '$75,000 to $99,999',
            'label': '$75,000 to $99,999',
            "value": data.DP03_0082E[radius],
        },
        {
            "id": '$100,000 to $149,999',
            'label': '$100,000 to $149,999',
            "value": data.DP03_0083E[radius],
        },
        {
            "id": '$150,000 to $199,999',
            'label': '$150,000 to $199,999',
            "value": data.DP03_0084E[radius],
        },
        {
            "id": '$200,000 or more',
            'label': '$200,000 or more',
            "value": data.DP03_0085E[radius],
        },
    ]
...
export default FamilyIncomeChart
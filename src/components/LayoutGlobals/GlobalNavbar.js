...
const GlobalNavbar = () => {
  ...
  return (
    auth.accessToken ? (
      <div className=' flex sticky top-0 z-50 justify-between p-2 md:mx-6 bg-white border-b-1'>
        ...
        <div className="flex items-center">
          <div className="hidden w-full md:block md:w-auto">
            ...
            md:bg-white">
              <li>
                <a href={`${BASE_URL}/about`} className="block py-2 pl-3 pr-4 text-sm text-gray-500 rounded hover:bg-gray-100 md:hover:bg-transparent hover:text-blue-700 md:border-0 md:p-0
                ">About</a>
              </li>
              <li>
      ...
      <div className='flex sticky top-0 z-50 justify-between p-2 md:mx-6 bg-white border-b-1'>
        ...
        <div className="flex items-center">
          <div className="hidden w-full md:block md:w-auto">
            ...
            md:bg-white">
              <li>
                <a href={`${BASE_URL}/about`} className="block py-2 pl-3 pr-4 text-sm text-gray-500 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 hover:text-blue-700 md:p-0
                ">About</a>
              </li>
              <li>

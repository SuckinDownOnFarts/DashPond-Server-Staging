...
const Login = () => {
  ...
  return (
    <div className="bg-light-gray flex justify-center items-center flex-grow flex-col">
      <div className="bg-white rounded-lg shadow-lg w-1/4">
        <div className="w-full p-8">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="text-xs text-center text-gray-500 uppercase">or login with email</div>
            <span className="border-b w-1/5 lg:w-1/4"></span>
          </div>
          ...
          {/* *************************************************    EMAIL    ******************************************************************* */}
            <div className="mt-4">
              ...
              {errors?.root?.serverError?.type === 401 && <p style={{color: "red" }}>Incorrect login information</p>}
              <input 
            ...
            <div className='mt-3 flex'>
              ...
              />
              <div className='text-gray-700 text-sm ml-2'>Remember me</div>
            </div>
      ...
      <div className='mt-3 clear-both flex-col text-center text-gray-700 text-xs'>
        <div>

...
import { Card, Col, AreaChart, Dropdown, DropdownItem, Flex, List, ListItem, Text, Title, Bold, Grid, Color, BarChart, 
        ...
        <Grid numColsSm={ 1 } numColsMd={ 1 } numColsLg={ 1 } className="mt-8 gap-x-6 gap-y-6">
            <Card className='h-full'>
                <div className="hidden sm:block">
                    <Flex className='space-x-4 justify-between items-center'>
